  ...
  <div id="main" class="main">
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            ...
            <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('daili');?>"><i class="btn-search"></i></a>
        </div>
    </div>
    <!-- 数据列表 -->
        ...
        <table class="">
            ...
            <tr>
                ...
                <th class="">
                    ...
                    <select name="status">
                        ...
                        <option value="0" <?php if(($_GET['status']) == "0"): ?>selected<?php endif; ?> >总代理</option>

                        <option value="1" <?php if(($_GET['status']) == "1"): ?>selected<?php endif; ?> >普通代理</option>
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                          ...
                          <!--  <a title="兑换记录" href="<?php echo U('/Control/Bidding/exchange?uid='.$vo['uid'].'&nickname='.$vo['nickname']);?>">兑换记录</a>
                            -->
                            <a title="查看代理信息" href="<?php echo U('userview?puid='.$vo['uid']);?>">查看</a>
							<a title="分享会员" href="<?php echo U('fenxianguser?puid='.$vo['uid']);?>">分享会员</a>
                            <a title="佣金记录" href="<?php echo U('fenyonglog?puid='.$vo['uid']);?>">佣金记录</a>
                            <a title="佣金记录" href="<?php echo U('orderlist?puid='.$vo['uid']);?>">新佣金</a>
                            <a title="佣金记录" href="<?php echo U('Branding/index?puid='.$vo['uid']);?>">推广代理</a>
                        </td>
