			...
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div class="form-item">
                    ...
                    <div class="form-item">
						...
						<div class="controls">
							<input type="text" name="description" class="text input-large" value="<?php echo ((isset($info["description"]) && ($info["description"] !== ""))?($info["description"]):''); ?>">
						</div>
					...
					<div class="form-item">
						...
						<label class="item-label">活动商品<span class="check-tips" style="color:red">(商品id,用逗号隔开如3,14,56,99)</span></label>

						<div class="controls">

							<input type="text" name="partner" class="text input-large" value="<?php echo ((isset($info["partner"]) && ($info["partner"] !== ""))?($info["partner"]):''); ?>">
					...
					<div class="form-item">
						...
						<div class="controls">
							...
							<label class="textarea input-large">
								...
								<input type="text" name="ord" class="text input-large" value="<?php echo ($info["ord"]); ?>">
