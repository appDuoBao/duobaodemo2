...
<div id="main-content">
  ...
  <div id="main" class="main">
	...
	<script type="text/javascript" src="/duobao/app/duobaodemo2/Public/static/uploadify/jquery.uploadify.min.js"></script>

	<script type="text/javascript" src="/duobao/app/duobaodemo2/Public/static/UploadImages.js"></script>
...
<!-- 		<li data-tab="tab99" <?php if(($key) == "1"): ?>class="current"<?php endif; ?>><a href="javascript:void(0);">商品属性</a></li> -->
	</ul>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
            ...
            "swf"             : "/duobao/app/duobaodemo2/Public/static/uploadify/uploadify.swf",
    ...
    function uploadPicture<?php echo ($field["name"]); ?>(file, data){
        ...
        if(data.status){
            ...
            src = data.url || '/duobao/app/duobaodemo2' + data.path;
...
<link href="/duobao/app/duobaodemo2/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">

<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/duobao/app/duobaodemo2/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>

<link href="/duobao/app/duobaodemo2/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">

<script type="text/javascript" src="/duobao/app/duobaodemo2/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>

<script type="text/javascript" src="/duobao/app/duobaodemo2/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
