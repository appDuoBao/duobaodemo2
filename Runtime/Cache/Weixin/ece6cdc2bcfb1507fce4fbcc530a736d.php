...
<body>
    <?php if(count($list) > 0): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="purchase_content">
    ...
    <div class="nomore">
        <p>您还没有购买过任何产品哦</p>
        <p>快<a href="<?php echo U(Index/index);?>">点击这里</a>去逛逛吧</p>
    </div><?php endif; ?>
