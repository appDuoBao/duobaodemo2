...
<head>
    ...
    <link rel="stylesheet" href="/Public/Weixin/css/register.css">
...
<div class="alert">
	<div class="content">
		...
		<form role="form" action="/Weixin/User/register/parent_id/0/root_id/0?code=001zyHqb0Sy30t1lEEub0zcoqb0zyHqB&state=1" method="post" id="formUser">
			<input type="hidden" name="">
			<div class="main">
				<div class="tel">
					<img src="/Public/Weixin/images/iphone.png" alt="" class="phone">
				...
				<div class="message">
					<img src="/Public/Weixin/images/check.png" alt="" class="mm">
