...
<head>
	...
	<link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Weixin/css/homePage2.css">
	<script src="http://lib.sinaapp.com/js/jquery/1.9.1/jquery-1.9.1.min.js"></script>
	<script type="text/javascript" src="/duobao/app/duobaodemo2/Public/Weixin/js/jquery-1.9.1.min.js"></script>
</head>
<body>
<div class="alert">
	<div class="content">
		<!--<div class="chead">手机注册</div>-->
		<form role="form" action="/duobao/app/duobaodemo2/index.php?s=/User/register" method="post" id="formUser">
			<input type="hidden" name="">
			<div class="main">
				<div class="tel">
					<input name="mobile" id="mobile" onblur="ismobile_registered();"  placeholder="请输入手机号">
					<img src="/duobao/app/duobaodemo2/Public/Weixin/images/iphone.png" alt="" class="phone">
					<span class="check_tips error_tip" id="dmobile"></span>

				</div>
				<div class="message">
					<input type="text" name="miss" id="miss" oninput="checkphone();" placeholder="请输入验证码">
					<img src="/duobao/app/duobaodemo2/Public/Weixin/images/check.png" alt="" class="mm">
