...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/duobao/app/duobaodemo2/Public/Weixin/css/swiper.min.css"/>
    <link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Weixin/css/homePage.css">
...
<div class="mainall">
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <?php if(is_array($data["indexImgs"])): $i = 0; $__LIST__ = $data["indexImgs"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide">
                    ...
                    <img src="/duobao/app/duobaodemo2<?php echo ($vo["path"]); ?>" />
    ...
    <div class="bgbottom fnTimeCountDown" data-end="<?php echo ($data["time_end"]); ?>">
        <img src="/duobao/app/duobaodemo2/Public/Weixin/images/laba_03.png" alt="">
        ...
        <ul class="lis"  >
            <?php if(is_array($data["buy_list"])): $i = 0; $__LIST__ = $data["buy_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><a href="<?php echo U('My/buyLog?uid='.$vo1['userinfo']['uid']);?>"> <li>
                    ...
                    <div class="lm">
                        ...
                        <p class="lm-gwk"><?php echo ($vo1["goods_title"]); ?>    购买第<?php echo ($vo1["period"]); ?>期    单×<?php echo ($vo1["buy_num"]); ?>  <?php echo ($vo1["type"]); ?></p>
                    </div>
                    <!--<div class="lt">
        ...
        <ul class="lis" style="display:none">
            <?php if(is_array($data["pk_list"])): $i = 0; $__LIST__ = $data["pk_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('My/buyLog?uid='.$vo['userinfo']['uid']);?>"><li>
                    ...
                    <div class="lm">
                        ...
                        <p class="lm-gwk"><?php echo ($vo["goods_title"]); ?>    中奖第<?php echo ($vo["period"]); ?>期    单×<?php echo ($vo["buy_num"]); ?>  <?php echo ($vo["codeid"]); ?></p>
...
<script src="/duobao/app/duobaodemo2/Public/Weixin/js/swiper.min.js" type="text/javascript" charset="utf-8"></script>
...
<script>
    ...
    function reload_more(){
        ...
        var url='Index/reloadMore?type='+num;
        $.ajax({
            type:"post",
            url:"<?php echo U('"+url+"');?>",
            data:"num="+num,
