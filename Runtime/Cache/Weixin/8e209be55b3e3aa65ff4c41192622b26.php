...
<head>
    ...
    <link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Weixin/css/personal_center.css">
    <script src="/duobao/app/duobaodemo2/Public/Weixin/js/jquery-1.9.1.min.js"></script>
</head>
<body>
    <div class="heand">
        <div class="head_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/head.png" alt=""></div>
        <div class="head_name">用户名</div>
    </div>
    <div id="mywallet" class="menu_personal" style="margin-top:5px;">
        <span class="menu_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/my_money.png" alt=""></span>
        <span class="menu_font">我的钱包</span>
        <span class="menu_right">〉</span>
    </div>
    <div id="exchangelog" class="menu_personal" style="margin-top:20px;">
        <span class="menu_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/dui.png" alt=""></span>
        <span class="menu_font">兑换记录</span>
        <span class="menu_right">〉</span>
    </div>
    <div id="trancepaylog" class="menu_personal" style="margin-top:5px;">
        <span class="menu_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/zhuan.png" alt=""></span>
        <span class="menu_font">我的转售</span>
        <span class="menu_right">〉</span>
    </div>
    <div id="buylog" class="menu_personal" style="margin-top:5px;">
        <span class="menu_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/buy.png" alt=""></span>
        <span class="menu_font">购买记录</span>
        <span class="menu_right">〉</span>
    </div>
    <?php if($isjoin != true): ?><div id="cooperation" class="menu_personal" style="margin-top:20px;">
        <span class="menu_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/he.png" alt=""></span>
        <span class="menu_font">合作申请</span>
        <span class="menu_right">〉</span>
    </div><?php endif; ?>
    <div id="plays" class="menu_personal" style="margin-top:20px;">
        <span class="menu_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/wan.png" alt=""></span>
        <span class="menu_font">玩法介绍</span>
        <span class="menu_right">〉</span>
    </div>
    <div id="outlog" class="menu_personal sign_out" style="margin-top:5px;">
        <span class="menu_img"><img src="/duobao/app/duobaodemo2/Public/Weixin/images/tui.png" alt=""></span>
