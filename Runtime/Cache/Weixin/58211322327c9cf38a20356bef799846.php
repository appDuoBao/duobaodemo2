...
<head>
    ...
    <link rel="stylesheet" href="/Public/Weixin/css/pay_order.css?t=1234">
...
<body>
    ...
    <p style="display:none" class="fnTimeCountDown" data-end="<?php echo ($data["time_end"]); ?>" >
    <div class="menu_personal" style="margin-top:18px;">
        <span class="menu_img"><img src="/Public/Weixin/images/money.png" alt=""></span>
        <span class="menu_font">余额支付</span>
        <span class="menu_right"><input type="radio" class="cbtest" checked  name="pay" value="3" /></span>
    </div>
	 ...
	 //如果微币少于钱数，提示选择支付方式
        ...
        $.ajax({
		   ...
		   if(ptype == 3){
			...
			alert(res.msg);
			window.location.href = "/weixin/my/recharge.html"; return;
                }else{
                   alert(res.msg);
                }
