...
<head>
    ...
    <link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Weixin/css/kaijiang10.css">

    <link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Weixin/css/kaijiang11.css">
...
<div class="mainall">
        ...
        <ul>
            ...
            <?php if(is_array($data["code_list"])): $i = 0; $__LIST__ = $data["code_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--
                ...
                <li>
                    ...
                    <div class="li3"><p <?php if($vo['code_56_type'] == '大'): ?>style="background:#C22631"<?php else: ?>style="background:#F5A623 "<?php endif; ?> ><?php echo ($vo["code_56"]); ?>&nbsp;&nbsp;<?php echo ($vo["code_56_type"]); ?></p></div>

                    <div class="li3 li4"><p <?php if($vo['code_110_type'] == '大'): ?>style="background:#C22631"<?php else: ?>style="background:#F5A623 "<?php endif; ?>><?php echo ($vo["code_110"]); ?>&nbsp;&nbsp;<?php echo ($vo["code_110_type"]); ?></p></div>
    ...
    <!--<div class="qiang">-->
        ...
        <!--<img src="/duobao/app/duobaodemo2/Public/Weixin/images/qiangbao_03.png" alt="">-->
    ...
    <!--<div class="hot">-->
        ...
        <!--<div class="wrap">-->
            ...
            <!--<div class="icon flex_row">-->
                ...
                <!--<img src="/duobao/app/duobaodemo2/Public/Weixin/images/1.png" alt="">-->
...
<div class="footer">
    <div class="f1">
        <a href="<?php echo U('Inedex/index');?>" class="active">
            ...
            <p style="color:#333;">首页</p>
        </a>
    </div>
    <div class="f2">
        <a href="<?php echo U('Openprize/index');?>">
            <img src="/duobao/app/duobaodemo2/Public/Weixin/images/icon-flows.png" alt="" />
            <p style="color:#C22631;">走势图</p>
        </a>
    </div>
    <div class="f3">
