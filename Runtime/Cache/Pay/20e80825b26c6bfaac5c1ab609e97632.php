...
<head>
	...
	<link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Pay/css/common.css">
	<link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Pay/css/homePage.css">
	<link rel="stylesheet" href="/duobao/app/duobaodemo2/Public/Pay/css/homePage2.css">
...
<div class="alert">
	<div class="content">
		...
		<form role="form" action="/duobao/app/duobaodemo2/pay.php?s=/User/register.html" method="post" id="formUser">
			<input type="hidden" name="">
			<div class="main">
				<div class="tel">
					<input name="mobile" id="mobile" onblur="ismobile_registered();"  placeholder="手机号">
					<img src="/duobao/app/duobaodemo2/Public/Pay/images/phone_03.jpg" alt="" class="phone">
					<span class="check_tips error_tip" id="dmobile"></span>

				</div>
				<div class="message">
					<input type="text" name="miss" id="miss" oninput="checkphone();" placeholder="验证码">
					<img src="/duobao/app/duobaodemo2/Public/Pay/images/phone2_03.jpg" alt="" class="mm">
...
<script type="text/javascript" src="/duobao/app/duobaodemo2/Public/Pay/js/libs/zepto.min.js"></script>
