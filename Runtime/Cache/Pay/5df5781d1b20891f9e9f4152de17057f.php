...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="card_img" >
        <img src="/duobao/app/duobaodemo2/Public/Pay/images/card_yin.png" alt="">
...
<div class="menu_fixed">
    <div class="bottom_menu" style="width:33.3%" id="main">
        <span class="menu_bottom_img" style="margin-left:105px;"><img src="/duobao/app/duobaodemo2/Public/Pay/images/icon-main.png" alt=""></span>
        <span class="menu_bottom_font ">首页</span>
    </div>
    <div class="bottom_menu" style="width:33.3%" id="bankcard">
        <span class="menu_bottom_img" style="margin-left:105px;"><img src="/duobao/app/duobaodemo2/Public/Pay/images/card_red.png" alt=""></span>
