...
<body>
  <form action="<?php echo U(docharge);?>" method="post" class="form-horizontal">   
    ...
    <div class="yes_btn" id="submit" >确定</div>
    ...
    <div class="resale_top" style="margin-top:20px;">
        <span class="resale_top_img"><img src="/Public/Pay/images/zhuan.png" alt=""></span><span style="padding-left:20px;">兑换码</span>
    </div>
    ...
    <div class="menu_fixed">
        <div class="bottom_menu" style="width:33.3%" id="main">
            <span class="menu_bottom_img" style="margin-left:105px;"><img src="/Public/Pay/images/icon-main-red.png" alt=""></span>
