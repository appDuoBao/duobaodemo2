...
<head>
    ...
    <link rel="stylesheet" href="/Public/Pay/css/bank_card.css">
...
<body>
  <form action="<?php echo U(bindcard);?>" method="post" class="form-horizontal">    
    ...
    <div class="card_content">
        ...
        <input type="text" name="bank_add"  placeholder="如四川省成都市春熙路支行">
    </div>
    <div class="card_content">
